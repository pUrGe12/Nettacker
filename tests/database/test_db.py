...
class TestDatabase:
    ...
    def test_db_inputs_postgres(self, mock_config):
        """Test db_inputs function for PostgreSQL"""
    ...
    def test_db_inputs_mysql(self, mock_config):
        """Test db_inputs function for MySQL"""
        mock_config.db.as_dict.return_value = {
            'username': 'user',
            'password': 'pass',
            'host': 'localhost',
    ...
    def test_create_connection_sqlite(self, mock_config_instance, mock_config_class, mock_apsw_conn):
        """Test create_connection function for SQLite"""
        # Setup mocks
    ...
    def test_create_connection_mysql(self, mock_config, mock_sessionmaker, mock_create_engine):
        """Test create_connection function for MySQL"""
    ...
    def test_send_submit_query_sqlalchemy_success(self):
        """Test send_submit_query with SQLAlchemy session - success case"""
        mock_session = Mock()
...
# submit_logs_to_db tests
    ...
    def test_apsw_busy_error(self, mock_create_conn, mock_warn):
        ...
        mock_warn.assert_called_with("[Retry 1/1] Database is locked. Retrying...")
